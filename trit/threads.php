...
echo $asciiArt;
echo "\n\n";
$username = readline("Masukkan username Instagram Lu: ");
$password = readline("Masukkan password Instagram Lu: ");
        ...
        foreach ($parsegetFeeds['items'] as $postingan) {
            ...
            if (isset($parseGaslike['status'])) {
                if ($parseGaslike['status'] == "ok") {
                    ...
                    $likeCount++;
                    sleep(14); // ATUR DELAY LIKE DI SINI
