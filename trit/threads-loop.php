...
$akunIG = [
    ['username' => 'MASUKAN USERNAME DISINI', 'password' => 'MASUKAN PASSWORD MU DISINI']]; // TIDAK ADA LOGGER
...
while(true) {
    ...
    if (!isset($header[1][0])){
        ...
        sleep(10); // Tidur selama 10 detik sebelum mencoba lagi
    } else {
        $token = $header[1][0];
        ...
        sleep(180); // Tidur selama 180 detik atau 3 menit
    }
}
